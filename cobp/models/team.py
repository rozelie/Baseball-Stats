...
TEAMS = [
    ...
    Team("CHA", "Chicago", "White Sox", 1901, 2022, baseball_reference_id="CHW"),
    Team("CHF", "Chicago", "Whales", 1914, 1915),
    Team("CHN", "Chicago", "Cubs", 1876, 2022, baseball_reference_id="CHC"),
    ...
    Team("HOU", "Houston", "Astros", 1965, 2022),
    Team("HOU", "Houston", "Colts", 1962, 1964),
    ...
    Team("KCA", "Kansas City", "Royals", 1969, 2022, baseball_reference_id="KCR"),
    ...
    Team("LAN", "Los Angeles", "Dodgers", 1958, 2022, baseball_reference_id="LAD"),
    ...
    Team("NYA", "New York", "Yankees", 1903, 2022, baseball_reference_id="NYY"),
    Team("NYN", "New York", "Mets", 1962, 2022, baseball_reference_id="NYM"),
    ...
    Team("SDN", "San Diego", "Padres", 1969, 2022, baseball_reference_id="SDP"),
    Team("SE1", "Seattle", "Pilots", 1969, 1969),
    Team("SEA", "Seattle", "Mariners", 1977, 2022),
    Team("SFN", "San Francisco", "Giants", 1958, 2022, baseball_reference_id="SFG"),
    ...
    Team("SLN", "St. Louis", "Cardinals", 1892, 2022, baseball_reference_id="STL"),
    ...
    Team("WAS", "Washington", "Nationals", 2005, 2022, baseball_reference_id="WSN"),
